...
AGI is able to replace half of the human population and maintain its functionality, in a pure random order. That is to say, there should be no prejudice based on income rates, ranks, educational backgrounds etc, in the process of replacement. AGI should blend into the human society. That is how it will define itself.
