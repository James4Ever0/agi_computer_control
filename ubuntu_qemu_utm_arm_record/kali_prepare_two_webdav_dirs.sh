...
# use absolute path.
nohup xvfb-run --server-num=12 --listen-tcp --server-args="-screen 0 1280x800x24" -f /tmp/.Xauthority2 gnome-terminal -- tmuxp load "/media/root/Toshiba XG3/works/agi_computer_control/ubuntu_qemu_utm_arm_record/kali_prepare_two_webdav_dirs.yaml" &
