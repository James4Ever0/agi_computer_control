...
tmux list-sessions -F '[#{session_name}] bell: #{window_bell_flag} slient: #{window_silence_flag} active: #{window_activity_flag} socket: #{socket_path} size: #{window_width}x#{window_height} cursor at: x=#{cursor_x},y=#{cursor_y}'
