...
class ANSI(term):
    ...
    def __init__(self, r=24, c=80, *args, **kwargs):
        ...
        self.state.add_transition_list(
            string.digits, "NUMBER_1", DoBuildNumber, "NUMBER_1"
        )
        ...
        self.state.add_transition_list(
            string.digits, "MODECRAP", DoStartNumber, "MODECRAP_NUM"
        )
        self.state.add_transition_list(
        ...
        self.state.add_transition_list(
            string.digits, "SEMICOLON", DoStartNumber, "NUMBER_2"
        )
        self.state.add_transition_list(
            string.digits, "NUMBER_2", DoBuildNumber, "NUMBER_2"
        )
        ...
        self.state.add_transition_list(
            string.digits, "SEMICOLON_X", DoStartNumber, "NUMBER_X"
        )
        self.state.add_transition_list(
            string.digits, "NUMBER_X", DoBuildNumber, "NUMBER_X"
        )
