...
x: "bchw" = tf.get_variable(
    "x", shape=(B, C, H, W), initializer=tf.random_normal_initializer()
)
...
mytensor = torch.randn(
    1, 2, 2, 3, names=("N", "C", "H", "W")
)  # still, not annotated. cannot check statically?
