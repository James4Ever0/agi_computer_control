(function () {
    ...
    function SettingsIcon(props) {
        return m$1(
            ...
            m$1(
                "g",
                {transform: "translate(8 8)", fill: props.color},
                m$1("path", {
    ...
    function MoreNewHighlight() {
        ...
        return m$1(
            "div",
            {class: "header__more-new-highlight"},
            m$1(
                "svg",
                {
                    class: "header__more-new-highlight__lines",
                    viewBox: "0 0 272 32",
                    width: "272",
                    height: "32"
                },
                m$1("path", {
                    d: `M${a1.x},${a1.y} Q${aq.x},${aq.y} ${a2.x},${a2.y}`
                }),
                m$1("path", {
                    d: `M${b1.x},${b1.y} Q${bq.x},${bq.y} ${b2.x},${b2.y}`
                }),
                m$1("circle", {cx: a2.x, cy: a2.y, r: r}),
                m$1("circle", {cx: b2.x, cy: b2.y, r: r})
            ),
            m$1("span", {class: "header__more-new-highlight__text"}, "New")
        );
    }
    ...
    function KeyboardIcon() {
        return m$1(
            ...
            m$1(
                "g",
                {"stroke": "var(--icon-color)", "stroke-width": "1"},
                        ...
                        Button,
                        {
                            class: {
                                ...
                                "header__more-settings__enabled-by-default__button--active":
                                    !data.settings.applyToListedOnly
                            },
    ...
    function AutomationPage(props) {
        ...
        return m$1(
            ...
            !isMatchMediaChangeEventListenerBuggy
                ...
                : m$1(
                      "p",
                      {class: "automation-page__warning"},
                      getLocalMessage("system_dark_mode_chromium_warning")
                  ),
            m$1(DropDown, {
                onChange: (selected) => changeAutomationBehavior(selected),
    ...
    function DevToolsGroup() {
        return m$1(
            ...
            m$1(
                ...
                m$1(
                    ResetButton$1,
                    {onClick: openDevTools$1, class: "dev-tools-button"},
                    "\uD83D\uDEE0 ",
    ...
    function IconButton(props, ...children) {
    ...
    function DeleteAllButton(props, ...content) {
        return m$1(
            IconButton,
            {class: "delete-all-button", onclick: props.onClick},
            m$1(
                "span",
                {class: "delete-all-button__content"},
                m$1("span", {class: "delete-all-button-icon"}),
                ...content
            )
        );
    }
    ...
    function RemoveAllButton(props) {
        ...
        return m$1(
            ControlGroup$1,
            {class: "delete-all-icon-group"},
            m$1(
                ControlGroup$1.Control,
                null,
                m$1(DeleteAllButton, {onClick: showDialog}, dialog)
            )
        );
    }
    ...
    function SiteListPage(props) {
        ...
        return m$1(
            ...
            props.data.settings.siteList.length
                ? m$1(RemoveAllButton, {...props})
                : null,
            m$1(SiteList, {
            ...
            m$1(
                "label",
                {class: "site-list-page__description"},
                "Enter website name and press Enter"
            ),
            m$1(CheckButton, {
    ...
    function ManageSettingsPage(props) {
        ...
        return m$1(
            ...
            canExportTheme ? m$1(ExportTheme, {...props}) : null,
    ...
    function Pages(props) {
        ...
        return m$1(
            ...
            m$1(Page, {id: "site-list"}, m$1(SiteListPage, {...props})),
            m$1(Page, {id: "automation"}, m$1(AutomationPage, {...props})),
            m$1(
                Page,
                {id: "manage-settings"},
            ...
            m$1(
                ...
                m$1(
                    ...
                    m$1(
                        "a",
                        {
                            class: "footer-links__link footer-help-link",
                            href: getHelpURL(),
                            target: "_blank",
                            rel: "noopener noreferrer"
                        },
                ...
                m$1(
                    ...
                    m$1(
                        Button,
                        {onclick: openDevTools, class: "dev-tools-button"},
                        "\uD83D\uDEE0 ",
                        getLocalMessage("open_dev_tools")
                    )
                )
    ...
    function renderBody(data, fonts, actions) {
        ...
        sync(
            document.body,
            m$1(Body$1, {data: data, actions: actions, fonts: fonts})
        );
    }
