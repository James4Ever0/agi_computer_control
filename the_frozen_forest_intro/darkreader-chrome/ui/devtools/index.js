(function () {
    ...
    function Body({data, actions, devtools}) {
        const context = getComponentContext();
        ...
        return m$1(
            ...
            m$1(
                ...
                m$1("h1", {id: "title"}, "Developer Tools")
            ),
            m$1("h3", {id: "sub-title"}, wrapper.header),
            m$1("textarea", {
                id: "editor",
            ...
            m$1("label", {id: "error-text"}, state.errorText),
            m$1(
                "div",
                {id: "buttons"},
            ...
            m$1(
                ...
                ". If a ",
                m$1("strong", null, "popular"),
                " website looks incorrect e-mail to ",
                m$1("strong", null, "DarkReaderApp@gmail.com")
            ),
            m$1(Overlay$1, null)
        );
    }
    ...
    function renderBody(data, devToolsData, actions) {
        sync(
            document.body,
            m$1(Body$1, {data: data, devtools: devToolsData, actions: actions})
        );
    }
